document.addEventListener("DOMContentLoaded", () => {
    ...
    telegramBtn.addEventListener("click", () => {
        ...
        const telegramHeader = document.createElement("p");
        telegramHeader.textContent = "اختر دولتك لزيارة قنوات تلغرام الرسمية";
        telegramHeader.className = "header";
        linksContainer.appendChild(telegramHeader);
